...
```
Get-CMOrgModelDeploymentRules [-Json] [-ISOnly] [-IncludeCollectionsWithNoDeployments]
 [[-CollectionQueries] <String[]>] [-Test] [[-TestCollectionQueries] <String[]>] [-RandomCollections]
 [[-RandomCollectionsNum] <Int32>] [[-Prefix] <String>] [[-SiteCode] <String>] [[-Provider] <String>]
 [[-CMPSModulePath] <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
### Example 1
```powershell
PS C:\> Get-CMOrgModelDeploymentRules -Json
```
...
### Example 2
```powershell
PS C:\> Get-CMOrgModelDeploymentRules -ISOnly -Json
```
...
Switch parameter if you want to include Deployment Collections even if they have no deployments.
